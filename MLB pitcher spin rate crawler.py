...
startMonth = 3; startDay = 28; endMonth = 10
...
#df.to_excel('C:/Users/mark9/OneDrive/桌面/output.xlsx')
#df.to_excel('/Users/mark0425/Desktop/output.xlsx')
print(df)
